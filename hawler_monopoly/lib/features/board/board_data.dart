...
List<TileData> buildBoardTiles() {
  const g = AppColors.propertyGroups;
  return [
    ...
    const TileData(name: 'گاراجی شار', type: TileType.station, price: 200, icon: FontAwesomeIcons.trainSubway),
    ...
    const TileData(name: 'کارەبای شار', type: TileType.station, price: 150, icon: Icons.bolt),
    TileData(name: 'گەڕەکی ئازادی', price: 140, groupColor: g[2]),
    TileData(name: 'گەڕەکی سەلاحەدین', price: 160, groupColor: g[2]),
    const TileData(name: 'گاراجی باشوور', type: TileType.station, price: 200, icon: FontAwesomeIcons.trainSubway),
    ...
    const TileData(name: 'گاراجی ڕۆژهەڵات', type: TileType.station, price: 200, icon: FontAwesomeIcons.trainSubway),
    TileData(name: 'گەڕەکی شاری زانا', price: 260, groupColor: g[5]),
    TileData(name: 'گەڕەکی گەلی کورد', price: 260, groupColor: g[5]),
    const TileData(name: 'ئاوی شار', type: TileType.station, price: 150, icon: Icons.water_drop),
    ...
    const TileData(name: 'گاراجی باکوور', type: TileType.station, price: 200, icon: FontAwesomeIcons.trainSubway),
    const TileData(name: 'ڕووداو', type: TileType.event, icon: Icons.auto_awesome),
